...
**Consolidated buy:** the three 100 nF (C1, C2, C4) are the same part - order **3x C14663**.
...
* **Through-hole J1** (cheaper, hand-solderable): a 1x4 2.54 mm header, e.g. LCSC **C2337**.
